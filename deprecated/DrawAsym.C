...
void DrawAsym(const char * filename="RedOutputset107ha.root", Int_t nbins_E=5, Int_t nbins_Pt=5)
{
  ...
  for(Int_t n_E=0; n_E<Ebins; n_E++)
  {
    for(Int_t n_Pt=0; n_Pt<Ptbins; n_Pt++)
    {
      ...
      if(cos_phi_bu[n_E][n_Pt]->GetEntries() * cos_phi_bd[n_E][n_Pt]->GetEntries())
      {
        ...
        {
          a = blue_an_fit_func->GetParameter(0);
          e = blue_an_fit_func->GetParError(0);
        }
        else { a=0; e=0; };
        ...
        if(a>0)
        {
          ...
          blue_an_2d_pos->SetBinError(n_Pt+1,n_E+1,e);
          blue_an_err_pos->SetBinContent(n_Pt+1,n_E+1,e);
        }
        else if(a<0) 
        {
          blue_an_2d_neg->SetBinContent(n_Pt+1,n_E+1,-1*a);
          blue_an_2d_neg->SetBinError(n_Pt+1,n_E+1,e);
          blue_an_err_neg->SetBinContent(n_Pt+1,n_E+1,e);
        };
      ...
      if(cos_phi_yu[n_E][n_Pt]->GetEntries() * cos_phi_yd[n_E][n_Pt]->GetEntries())
      {
        ...
        {
          a = yell_an_fit_func->GetParameter(0);
          e = yell_an_fit_func->GetParError(0);
        }
        else { a=0; e=0; };
        ...
        if(a>0) 
        {
          ...
          yell_an_2d_pos->SetBinError(n_Pt+1,n_E+1,e);
          yell_an_err_pos->SetBinContent(n_Pt+1,n_E+1,e);
        }
        else if(a<0) 
        {
          yell_an_2d_neg->SetBinContent(n_Pt+1,n_E+1,-1*a);
          yell_an_2d_neg->SetBinError(n_Pt+1,n_E+1,e);
          yell_an_err_neg->SetBinContent(n_Pt+1,n_E+1,e);
        };
         ...
         cos_phi_bdyd[n_E][n_Pt]->GetEntries())
      {
        ...
        {
          a = double_all_fit_func->GetParameter(0);
          e = double_all_fit_func->GetParError(0);
        }
        else { a=0; e=0; };
        ...
        if(a>0) 
        {
          ...
          double_all_2d_pos->SetBinError(n_Pt+1,n_E+1,e);
          double_all_err_pos->SetBinContent(n_Pt+1,n_E+1,e);
        }
        else if(a<0) 
        {
          double_all_2d_neg->SetBinContent(n_Pt+1,n_E+1,-1*a);
          double_all_2d_neg->SetBinError(n_Pt+1,n_E+1,e);
          double_all_err_neg->SetBinContent(n_Pt+1,n_E+1,e);
        };
